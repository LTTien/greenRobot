...
#pragma config(Motor,  port1,           RT,            tmotorVex393, openLoop, encoder, encoderPort, I2C_1, 1000)
#pragma config(Motor,  port2,           RB,            tmotorVex393, openLoop)
#pragma config(Motor,  port8,           LT,            tmotorVex393, openLoop, encoder, encoderPort, I2C_2, 1000)
#pragma config(Motor,  port9,           LB,            tmotorVex393HighSpeed, openLoop)
