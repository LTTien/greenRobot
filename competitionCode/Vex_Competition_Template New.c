...
void pivotClockwise (int goRight)    {
	while(SensorValue[driveFrontRightEncoder] < goRight && SensorValue[driveRearRightEncoder] < goRight)   {
...
void pivotCounterClockwise (int goLeft)  {
    while(SensorValue[driveFrontLeftEncoder] < goLeft && SensorValue[driveRearLeftEncoder] < goLeft)    {
		  motor[driveFrontRight] = 40;	// 5
			motor[driveRearRight] = 40;
			motor[driveFrontLeft] = -40;	// 5
			motor[driveRearLeft] = -40;
